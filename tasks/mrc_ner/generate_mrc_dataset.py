...
from data_preprocess.file_utils import load_conll, load_conll03_documents, load_conll03_sentences
...
def generate_query_ner_dataset(source_file_path, dump_file_path, entity_sign="nested",
    ...
    elif entity_sign == "flat_enconll03_docs":
        source_data = load_conll03_documents(source_file_path)
    elif entity_sign == "flat_enconll03_sents":
        source_data = load_conll03_sentences(source_file_path)
    else:
...
def transform_examples_to_qa_features(query_map, entity_labels, data_instances, entity_sign="nested"):
    ...
    elif "nested" in entity_sign.lower():
        tmp_qas_id = 0
